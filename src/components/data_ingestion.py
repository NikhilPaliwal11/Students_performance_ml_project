...
# All the inputs required for DataIngestion component
@dataclass
...
class DataIngestion:
    def __init__(self):
        self.ingestion_config = DataIngestionConfig()   # Now injestion config contains all folder name which we define in DataInjestioncofig class.     

    #This function is used to save the excel file in form of raw data ,train and test. 
